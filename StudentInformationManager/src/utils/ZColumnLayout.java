...
public class ZColumnLayout implements LayoutManager2 {
    ...
    private int gap=2;
    private boolean usePerferredSize=false;//竖直方向是否占满
    public ZColumnLayout(){

    }
    public ZColumnLayout(int gap){
        this.gap=gap;
    }
    public ZColumnLayout(int gap,boolean usePerferredSize){
        this.gap=gap;
